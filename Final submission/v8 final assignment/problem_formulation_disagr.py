...
def get_model_for_problem_formulation2(problem_formulation_id):
    ...
    dike_lev = {'A.5_DikeIncrease 0':[0],
                'A.5_DikeIncrease 1':[0],
                'A.5_DikeIncrease 2':[0],
                'A.4_DikeIncrease 0':[0],
                'A.4_DikeIncrease 1':[0],
                'A.4_DikeIncrease 2':[0],
                'A.1_DikeIncrease 0':[0,10],
                'A.1_DikeIncrease 1':[0,10],
                'A.1_DikeIncrease 2':[0,10],
                'A.2_DikeIncrease 0':[0,10],
                'A.2_DikeIncrease 1':[0,10],
                'A.2_DikeIncrease 2':[0,10],
                'A.3_DikeIncrease 0':[0,10],
                'A.3_DikeIncrease 1':[0,10],
                'A.3_DikeIncrease 2':[0,10],}
